...
# ===================================================================================================================
# Version[3]: In this version of the code, we moved the user info to a different file and then we calling the user_app
# module from here. by doing this we are changing the application from being monolithic. There are multiple way to call
# the module, bellow is one way of calling a module. Here we are importing the whole module.
# ===================================================================================================================
# import users_app
#
# app_user_one = users_app.User("flyboy@coding.com", "FlyBoy John", "pwd1", "DevOps Engineer")
# app_user_one.get_user_info()
#
# app_user_one.change_job_title("Cloud Engineer")
# app_user_one.get_user_info()
#
# app_user_two = users_app.User("nanaboro@nash.com", "James Nanaboro", "safe_secrets", "Personal Trainer")
...
# Exercise 2 === Exercise 2 : Create a Class User.
# =====================================================================================================================
# Version[4]: In this version of the code, we moved the user info to a different file and then we calling the user_app
# module from here. by doing this we are changing the application from being monolithic. There are multiple way to call
...
from helloWorld.venv.Project1.users_app import User
